...
echo "===================== Installing chaincode ${VERSION} on peer0.org1 ===================== "
installChaincode 0 1 ${VERSION}

echo "===================== Installing chaincode ${VERSION} on peer1.org1 ===================== "
installChaincode 1 1 ${VERSION}

echo "===================== Installing chaincode ${VERSION} on peer0.org2 ===================== "
installChaincode 0 2 ${VERSION}

echo "===================== Installing chaincode ${VERSION} on peer1.org2 ===================== "
installChaincode 1 2 ${VERSION}

echo "===================== Upgrading chaincode ${VERSION} on peer0.org1 ===================== "
upgradeChaincode 0 1 ${VERSION}

echo
echo "========= Finished upgrading chaincode ${VERSION} on your first network! ========= "
echo
