...
set -x
export FABRIC_CA_CLIENT_TLS_CERTFILES=/etc/hyperledger/fabric.com/tlsca-server/tlsca/tlsca.fabric.com-cert.pem
export FABRIC_CA_CLIENT_HOME=/etc/hyperledger/fabric.com/tlsca-admin
